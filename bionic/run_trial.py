...
def run_bionic(trial):
    ...
    print(f"BIONIC {epochs} {learning_rate} {gat_dim} {gat_heads} {gat_layers} {trial}")

    os.system(
        f"sbatch sbatch_bionic.sh {epochs} {learning_rate} {gat_dim} {gat_heads} {gat_layers} {trial}"
    )
